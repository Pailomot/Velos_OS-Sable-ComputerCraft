...
local WIDGET_DEFS = {
  ...
  { id = "inventario",     label = "Inventario",          default = true,  requires = "inventory"      },
  ...
  { id = "red",            label = "Red / Modem",         default = true,  requires = "modem"          },
  { id = "display_ext",    label = "Display externo",     default = true,  requires = "display_target" },
}
